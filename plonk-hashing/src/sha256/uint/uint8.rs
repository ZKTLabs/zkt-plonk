...
// impl<F: Field> FullUint8<F> {
//     pub fn and(&self, cs: &mut ConstraintSystem<F>, other: &Self) -> Self {
//         match self {
//             Self::Uint8(x) => {
//                 match other {
//                     Self::Uint8(y) => Self::Uint8(x.and(cs, y)),
//                     Self::Constant(y) => Self::Uint8(x.and_with_const(cs, *y)),
//                 }
//             }
//             Self::Constant(x) => {
//                 match other {
//                     Self::Uint8(y) => Self::Uint8(y.and_with_const(cs, *x)),
//                     Self::Constant(y) => Self::Constant(x & y),
//                 }
//             }
//         }
...
//             Self::Uint8(x) => {
//                 match other {
//                     Self::Uint8(y) => Self::Uint8(x.xor(cs, y)),
//                     Self::Constant(y) => Self::Uint8(x.xor_with_const(cs, *y)),
//                 }
//             }
//             Self::Constant(x) => {
//                 match other {
//                     Self::Uint8(y) => Self::Uint8(y.xor_with_const(cs, *x)),
//                     Self::Constant(y) => Self::Constant(x ^ y),
//                 }
//             }
//         }
...
//             Self::Uint8(x) => {
//                 match other {
//                     Self::Uint8(y) => Self::Uint8(x.not_and(cs, y)),
//                     Self::Constant(y) => Self::Uint8(x.not_and_with_const(cs, *y)),
//                 }
//             }
//             Self::Constant(x) => {
//                 match other {
